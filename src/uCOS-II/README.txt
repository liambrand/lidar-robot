This version of uC/OS-II is based on the Quantum Leaps generic port for
ARM-Cortex-M4. 

Configuration files for the OS are contained in uCOS-II/Config.

The port is intended to be used with the mbed-cli tools and mbed OS2.
...
uCOS-II Ports
=============
The folder "Ports" contains the generic uCOS-II Port for ARM-Cortex-M4.
